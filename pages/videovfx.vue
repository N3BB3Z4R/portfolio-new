<template>
  <div class="container">
    <div>
      ...
      Video production: Promos, Teaser, Documentary, Shortfilm, Tutorial, CC, DoP, Editing/VFX/Tracking/3D. Branding, Lifestyle & Product Photography. Sound works: OST, Jingles, basetracks, SFX Foley, audio production. Web design and Android UI/UX front-end developing and design.
      As 1st or 2nd camera unit, video editor and live soundman in different projects around the world. Video editing and production with Adobe CC. Color correction in DaVinci Resolve. Video graphics, 3D/2D animations, motiongraphics, masks, 3rds, and tracking integration. Audio recording and mixing for documentaries, shortfilms, spots, ads and other formas for social networks. Report, documentary and studio photography. Clients as Mediaset, AECID, AECC, Taramparo (Mercedes Mila), Samsung.
      </p> -->
      ...
      <Gallery :images="imagesVideovfx" />
    </div>
  </div>
</template>

<script>
import { IMAGES_VIDEOVFX } from '../constants/images.js'
export default {
  data() {
    return { imagesVideovfx: IMAGES_VIDEOVFX }
  }
}
</script>
